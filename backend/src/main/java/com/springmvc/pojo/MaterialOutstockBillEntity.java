...
public class MaterialOutstockBillEntity {
    /**
     * 物料出库单ID
     * 表字段 : material_outstock_bill.bill_id
     */
    private Integer billId;

    /**
     * 物料出库单编号
     * 表字段 : material_outstock_bill.bill_no
     */
    private String billNo;

    /**
     * 领料人
     * 表字段 : material_outstock_bill.to_principal
     */
    private Integer toPrincipal;

    /**
     * 仓库负责人
     * 表字段 : material_outstock_bill.warehouse_principal
     */
    private Integer warehousePrincipal;

    /**
     * 物料出库单创建时间
     * 表字段 : material_outstock_bill.bill_time
     */
    private Date billTime;

    /**
     * 物料去向（1领料出库）
     * 表字段 : material_outstock_bill.material_whereabouts
     */
    private Integer materialWhereabouts;

    /**
     * 相关领料单ID
     * 表字段 : material_outstock_bill.related_bill
     */
    private Integer relatedBill;

    /**
     * 物料出库单状态（1待审核，2已审核，3已完成）
     * 表字段 : material_outstock_bill.bill_state
     */
    private Integer billState;

    /**
     * 备注
     * 表字段 : material_outstock_bill.remark
     */
    private String remark;

    /**
     * 审核时间
     * 表字段 : material_outstock_bill.audit_at
     */
    private Date auditAt;

    /**
     * 审核者
     * 表字段 : material_outstock_bill.audit_by
     */
    private Integer auditBy;

    /**
     * 完成时间
     * 表字段 : material_outstock_bill.finish_at
     */
    private Date finishAt;

    /**
     * 完成者
     * 表字段 : material_outstock_bill.finish_by
     */
    private Integer finishBy;

    /**
     * 创建时间
     * 表字段 : material_outstock_bill.create_at
     */
    private Date createAt;

    /**
     * 创建者
     * 表字段 : material_outstock_bill.create_by
     */
    private Integer createBy;

    /**
     * 更新时间
     * 表字段 : material_outstock_bill.update_at
     */
    private Date updateAt;

    /**
     * 更新者
     * 表字段 : material_outstock_bill.update_by
     */
    ...
    public String toString() {
        ...
        sb.append(", materialWhereabouts=").append(materialWhereabouts);
