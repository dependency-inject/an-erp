...
public class MaterialInstockBillEntity {
    /**
     * 物料入库单ID
     * 表字段 : material_instock_bill.bill_id
     */
    private Integer billId;

    /**
     * 物料入库单编号
     * 表字段 : material_instock_bill.bill_no
     */
    private String billNo;

    /**
     * 交料人
     * 表字段 : material_instock_bill.from_principal
     */
    private Integer fromPrincipal;

    /**
     * 仓库负责人
     * 表字段 : material_instock_bill.warehouse_principal
     */
    private Integer warehousePrincipal;

    /**
     * 物料入库单创建时间
     * 表字段 : material_instock_bill.bill_time
     */
    private Date billTime;

    /**
     * 物料来源（1退料入库，2采购入库）
     * 表字段 : material_instock_bill.material_source
     */
    private Integer materialSource;

    /**
     * 相关退料单ID（采购入库时为空）
     * 表字段 : material_instock_bill.related_bill
     */
    private Integer relatedBill;

    /**
     * 物料入库单状态（1待审核，2已审核，3已完成）
     * 表字段 : material_instock_bill.bill_state
     */
    private Integer billState;

    /**
     * 备注
     * 表字段 : material_instock_bill.remark
     */
    private String remark;

    /**
     * 审核时间
     * 表字段 : material_instock_bill.audit_at
     */
    private Date auditAt;

    /**
     * 审核者
     * 表字段 : material_instock_bill.audit_by
     */
    private Integer auditBy;

    /**
     * 完成时间
     * 表字段 : material_instock_bill.finish_at
     */
    private Date finishAt;

    /**
     * 完成者
     * 表字段 : material_instock_bill.finish_by
     */
    private Integer finishBy;

    /**
     * 创建时间
     * 表字段 : material_instock_bill.create_at
     */
    private Date createAt;

    /**
     * 创建者
     * 表字段 : material_instock_bill.create_by
     */
    private Integer createBy;

    /**
     * 更新时间
     * 表字段 : material_instock_bill.update_at
     */
    private Date updateAt;

    /**
     * 更新者
     * 表字段 : material_instock_bill.update_by
     */
