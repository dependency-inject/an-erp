...
public class DevelopmentDrawService extends BaseService {
    ...
    public DrawMaterialBill getBillById(Integer billId) {
        ...
        if (drawMaterialBill.getDrawReason() != 2) {
            return null;
        }
    ...
    public PageMode<DrawMaterialBill> pageBill(Integer current, Integer limit, String sortColumn, String  sort,
        ...
        // 搜索编号
        DrawMaterialBillQuery.Criteria criteria = drawMaterialBillQuery.or().andDrawReasonEqualTo(2);
        ...
        // 搜索领料人
        criteria = drawMaterialBillQuery.or().andDrawReasonEqualTo(2);
        if (!ParamUtils.isNull(searchKey)) {
    ...
    public DrawMaterialBill addBill(String remark, List<DrawMaterialBillMaterial> materialList) {
        ...
        drawMaterialBill.setDrawReason(2);
        drawMaterialBill.setBillState(1);
