    ...
    <div class="main-panel no-scroll">
        <div class="main-panel-content">
            ...
            <div class="main-content">
                <i-table :height="tableHeight" ref="table" :columns="columnList" :data="vm.items" @on-sort-change="handleSort" @on-selection-change="selectItems=arguments[0]" @detail="$router.push('/warehouse/'+arguments[0][vm.identity])" @remove="remove([arguments[0]])"></i-table>
            </div>
            <!-- 翻页控制器 -->
