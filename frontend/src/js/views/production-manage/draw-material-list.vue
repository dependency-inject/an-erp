		...
		<div class="main-panel-content">
			<div class="operate-panel">
				...
				<div class="pull-left operate-list" v-show="selectItems!=''">
					...
					<!-- 审核 -->
					<span class="label-btn" @click="audit(selectItems)" v-if="productionDrawAuditPermission"><icon type="checkmark"></icon>{{ $t('common.AUDIT') }}</span>
					<!-- 反审核 -->
					<span class="label-btn" @click="unaudit(selectItems)" v-if="productionDrawAuditPermission"><icon type="reply"></icon>{{ $t('common.UNAUDIT') }}</span>
					<!-- 删除 -->
					<span class="label-btn" @click="remove(selectItems)" v-if="productionDrawRemovePermission"><icon type="trash-a"></icon>{{ $t('common.REMOVE') }}</span>
				</div>
