        ...
        <div class="main-panel-content">
            <div class="operate-panel">
                <div class="pull-left operate-list" v-show="selectItems==''">
                    ...
                    <!-- 搜索框 -->
                    <i-input :placeholder="$t('component.PLEASE_INPUT')+$t('field.ORDER.BILL_NO')+'/'+$t('field.ORDER.SALES_MAN')+'/'+$t('field.ORDER.CLIENT')" v-model="vm.queryParameters.searchKey" @on-enter="search" style="width:280px"></i-input>
                    <!-- 日期选择框 -->
                ...
                <div class="pull-left operate-list" v-show="selectItems!=''">
                    ...
                    <!-- 审核 -->
                    <span class="label-btn" @click="audit(selectItems)" v-if="orderAuditPermission"><icon type="checkmark"></icon>{{ $t('common.AUDIT') }}</span>
                    <!-- 反审核 -->
                    <span class="label-btn" @click="unaudit(selectItems)" v-if="orderAuditPermission"><icon type="reply"></icon>{{ $t('common.UNAUDIT') }}</span>
                    <!-- 删除 -->
                    <span class="label-btn" @click="remove(selectItems)" v-if="orderRemovePermission"><icon type="trash-a"></icon>{{ $t('common.REMOVE') }}</span>
                </div>
                <!--新增订单按钮-->
